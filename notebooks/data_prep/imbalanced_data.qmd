...
When working with presence-only records for your study species, a common approach is to sample a relatively large number of random samples from the study area. These random samples area referred to **background** or **pseudo-absence points [@valavi2022predictive].**
...
```{r disk_bg, warning=FALSE, message=FALSE}
